...
class GeoShapeUtil extends import_editor.BaseBoxShapeUtil {
    ...
    switch (shape.props.geo) {
      case "cloud": {
        body = new import_editor.Polygon2d({
          points: (0, import_geo_shape_helpers.cloudOutline)(w, h, shape.id, shape.props.size),
          isFilled
        });
        break;
      }
  ...
  component(shape) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_editor.SVGContainer, { id, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_GeoShapeBody.GeoShapeBody, { shape, shouldScale: true }) }),
  ...
  indicator(shape) {
    ...
    switch (props.geo) {
      ...
      case "cloud": {
        return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: (0, import_geo_shape_helpers.getCloudPath)(w, h, id, size) });
      }
      default: {
  ...
  toSvg(shape, ctx) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_GeoShapeBody.GeoShapeBody, { shouldScale: false, shape: newShape }),
      textEl
    ] });
  }
  getCanvasSvgDefs() {
