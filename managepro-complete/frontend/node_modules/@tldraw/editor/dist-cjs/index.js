...
__export(src_exports, {
  ...
  centerOfCircleFromThreePoints: () => import_utils.centerOfCircleFromThreePoints,
  ...
  debugFlags: () => import_debug_flags2.debugFlags,
  ...
  featureFlags: () => import_debug_flags2.featureFlags,
  ...
  getPointsOnArc: () => import_utils.getPointsOnArc,
...
var import_EnvironmentManager = require("./lib/editor/managers/EnvironmentManager");
...
var import_debug_flags2 = require("./lib/utils/debug-flags");
...
function debugEnableLicensing() {
  import_debug_flags.featureFlags.enableLicensing.set(true);
}
